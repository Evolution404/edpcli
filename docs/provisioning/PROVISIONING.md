...
| Q2 Inspect topology + presentation | IN PROGRESS | 单扇区 Tree 去冗余范围、盘尾五段互斥连续 primary spans、被动预览失败的显式 `r` retry 已实现；Inspect/TUI 专项通过。Summary、Detail、view-model cache 仍在实施。 |
